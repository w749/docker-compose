...
export MASTER_FAILOVER_INTERVAL=${MASTER_FAILOVER_INTERVAL:-"10"}
export MASTER_KILL_YARN_JOB_WHEN_HANDLE_FAILOVER=${MASTER_KILL_YARN_JOB_WHEN_HANDLE_FAILOVER:-"true"}
export MASTER_PERSIST_EVENT_STATE_THREADS=${MASTER_PERSIST_EVENT_STATE_THREADS:-"10"}
...
export WORKER_RETRY_REPORT_TASK_STATUS_INTERVAL=${WORKER_RETRY_REPORT_TASK_STATUS_INTERVAL:-"10"}
